...
class AnomalyDetector:
    def __init__(self):
        ...
        self.network_threat_classifier = None
        self.email_threat_classifier = None
    ...
    def _classify_network_threat_fallback(self, features):
        ...
        # DDoS: High packet rate with minimal response
    ...
    def _classify_email_threat_fallback(self, features):
        ...
        # Phishing: Short subject + attachment + small body
        if subject_length < 15 and has_attachment and body_length < 300:
        ...
        # Data Leakage: Large email with many attachments
        if email_size > 30000 and num_attachments > 4:
            return 'data_leakage', 0.90
        
        # Malware: Multiple attachments with small body
        if num_attachments > 1 and body_length < 150:
            return 'malware', 0.75
